...
var xr = (a, r, e) =>
    r in a
      ? Ur(a, r, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (a[r] = e),
  P = (a, r) => {
    for (var e in r || (r = {})) Yr.call(r, e) && xr(a, e, r[e]);
    if (yr) for (var e of yr(r)) Zr.call(r, e) && xr(a, e, r[e]);
    return a;
  },
  nr = (a, r) => Jr(a, Qr(r));
import {
...
import { R as T, r as d } from './index.d1b1a1f8.js';
import './iframe.99391157.js';
import { j as y, a as K } from './jsx-runtime.bd940121.js';
...
var X = function (r, e, n) {
  ...
  kr = function (r, e, n) {
    var t = r.getBoundingClientRect(),
      o = A(e)
        ...
        : e;
    return {
      left: X((o.pageX - (t.left + vr(r).pageXOffset)) / t.width),
      top: X((o.pageY - (t.top + vr(r).pageYOffset)) / t.height)
    };
  },
  Mr = function (r) {
    !A(r) && r.preventDefault();
  },
  br = T.memo(function (a) {
    var r = a.onMove,
      e = a.onKey,
      n = gr(a, ['onMove', 'onKey']),
          ...
          return [
            function (m) {
              ...
              if (
                ...
                p.focus(), o(kr(p, h, u.current)), O(!0);
              }
            },
            function (m) {
  ...
  fe = function (r, e) {
    return e === void 0 && (e = 'deg'), Number(r) * (ve[e] || 1);
  },
  he = function (r) {
    var e =
    ...
    return y('div', {
      ...
      children: T.createElement(
        br,
        {
          ...
          onKey: function (o) {
            e({
              s: X(r.s + 100 * o.left, 0, 100),
              v: X(r.v - 100 * o.top, 0, 100)
            });
          },
          'aria-label': 'Color',
          'aria-valuetext':
...
var ge =
  ...
  me = function (r) {
    var e = r.className,
      ...
      i = r.onChange,
      u = gr(r, ['className', 'colorModel', 'color', 'onChange']),
      l = d.exports.useRef(null);
    Vr(l);
    var c = qr(n, o, i),
      v = c[0],
      f = c[1],
      x = D(['react-colorful', e]);
    return K(
      'div',
      nr(P({}, L({}, u, { ref: l, className: x })), {
        children: [
          y(Br, { hsva: v, onChange: f }),
          y(Lr, {
            hue: v.h,
            onChange: f,
  ...
  ye = {
    ...
    fromHsva: function (r) {
      return (n = (e = jr(r)).g), (t = e.b), '#' + or(e.r) + or(n) + or(t);
      var e, n, t;
    },
    equal: function (r, e) {
      return r.toLowerCase() === e.toLowerCase() || Xr(tr(r), tr(e));
    }
  },
  xe = function (r) {
    return T.createElement(me, L({}, r, { colorModel: ye }));
  },
  we = function (r) {
    var e = r.className,
      n = r.hsva,
  ...
  Me = function (r) {
    return y(Ar, P({}, L({}, r, { colorModel: ke })));
  },
  Ce = {
  ...
  Se = function (r) {
    return y(Ar, P({}, L({}, r, { colorModel: Ce })));
  },
  Ee = {
  ...
  W = Ee,
  Gr = {};
for (var ir = 0, Sr = Object.keys(W); ir < Sr.length; ir++) {
  var Er = Sr[ir];
  Gr[W[Er]] = Er;
}
var s = {
...
for (var ur = 0, _r = Object.keys(s); ur < _r.length; ur++) {
  ...
  delete s[I].channels,
    delete s[I].labels,
    Object.defineProperty(s[I], 'channels', { value: _e }),
    Object.defineProperty(s[I], 'labels', { value: Oe });
}
...
function He(a) {
  ...
  for (r[a].distance = 0; e.length; )
    for (
      var n = e.pop(), t = Object.keys(rr[n]), o = t.length, i = 0;
      i < o;
      i++
    ) {
      var u = t[i],
...
function Te(a, r) {
  for (
    var e = [r[a].parent, a], n = rr[r[a].parent][a], t = r[a].parent;
    r[t].parent;

  )
    e.unshift(r[t].parent), (n = Ne(rr[r[t].parent][t], n)), (t = r[t].parent);
  return (n.conversion = e), n;
}
var Fe = function (r) {
    for (
      var e = He(r), n = {}, t = Object.keys(e), o = t.length, i = 0;
      i < o;
      i++
    ) {
      var u = t[i],
        l = e[u];
      l.parent !== null && (n[u] = Te(u, e));
    }
    return n;
  },
  hr = Kr,
...
je.forEach(function (a) {
  (B[a] = {}),
    Object.defineProperty(B[a], 'channels', { value: hr[a].channels }),
    Object.defineProperty(B[a], 'labels', { value: hr[a].labels });
  var r = Pe(a),
    e = Object.keys(r);
  e.forEach(function (n) {
    var t = r[n];
    (B[a][n] = Le(t)), (B[a][n].raw = ze(t));
  });
});
var R = B,
  Be = oe,
  ...
  qe = /\s/;
function Ve(a) {
  for (var r = a.length; r-- && qe.test(a.charAt(r)); );
  return r;
}
var Ae = Ve,
  Ge = Ae,
  Ke = /^\s+/;
function We(a) {
  return a && a.slice(0, Ge(a) + 1).replace(Ke, '');
}
var De = We,
  Ue = De,
  Ir = pr,
...
function ea(a) {
  ...
  a = Ue(a);
  var e = Ye.test(a);
  return e || Ze.test(a) ? ra(a.slice(2), e ? 2 : 8) : Qe.test(a) ? Rr : +a;
}
var aa = ea,
  na = pr,
  lr = $e,
...
function fa(a, r, e) {
  var n = !0,
    t = !0;
  if (typeof a != 'function') throw new TypeError(va);
  return (
    sa(e) &&
      ((n = 'leading' in e ? !!e.leading : n),
      (t = 'trailing' in e ? !!e.trailing : t)),
    ca(a, r, { leading: n, maxWait: r, trailing: t })
  );
}
var ha = fa,
  da = j.div({ position: 'relative', maxWidth: 250 }),
  pa = j(Fr)({ position: 'absolute', zIndex: 1, top: 4, left: 4 }),
  ga = j.div({
    width: 200,
    margin: 5,
  ...
  xa = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`,
  Nr = function (r) {
    var e = r.value,
      n = r.active,
      t = r.onClick,
      o = r.style,
      i = te(r, ['value', 'active', 'onClick', 'style']),
      u = 'linear-gradient('
        .concat(e, ', ')
        .concat(e, '), ')
        .concat(xa, ', linear-gradient(#fff, #fff)');
    return y(
      ya,
      P(
        {},
...
var Q = Object.values(b),
  ...
  Ca = /^\s*rgba?\(([0-9]+),\s*([0-9]+),\s*([0-9]+),?\s*([0-9.]+)?\)\s*$/i,
  Sa = /^\s*hsla?\(([0-9]+),\s*([0-9]+)%,\s*([0-9]+)%,?\s*([0-9.]+)?\)\s*$/i,
  dr = /^\s*#?([0-9a-f]{3}|[0-9a-f]{6})\s*$/i,
  Ea = /^\s*#?([0-9a-f]{3})\s*$/i,
  _a = ((q = {}), E(q, b.HEX, xe), E(q, b.RGB, Se), E(q, b.HSL, Me), q),
  Y =
    ((V = {}),
    E(V, b.HEX, 'transparent'),
    E(V, b.RGB, 'rgba(0, 0, 0, 0)'),
    E(V, b.HSL, 'hsla(0, 0%, 0%, 0)'),
    V),
  Tr = function (r) {
  ...
  G = function (r) {
    ...
    if (!!r) {
      ...
      var J = r.replace('#', ''),
        $ = R.keyword.rgb(J) || R.hex.rgb(J),
        ar = R.rgb.hsl($),
        z = r;
      if (
        (/[^#a-f0-9]/i.test(r) ? (z = J) : dr.test(r) && (z = '#'.concat(J)),
        z.startsWith('#'))
      )
        n = dr.test(z);
      else
  ...
  Ia = function (r, e) {
    ...
    var O = d.exports.useMemo(
      ...
      h = d.exports.useCallback(
        function () {
          var p = Q.indexOf(k) + 1;
          p >= Q.length && (p = 0), C(Q[p]);
          var g = (c == null ? void 0 : c[Q[p]]) || '';
          i(g), e(g);
        },
        [c, k, e]
      );
        ...
        function () {
          var v = (r || []).map(function (f) {
            return typeof f == 'string'
              ? G(f)
              : f.title
              ? Object.assign(Object.assign({}, G(f.color)), {
                  keyword: f.title
                })
              : G(f.color);
          });
    ...
    return K(da, {
      children: [
        y(pa, {
                ...
                y(ma, {
                  children: h.map(function (M, S) {
                    return y(
                      ...
                      {
                        hasChrome: !1,
                        tooltip: y(ba, { note: M.keyword || M.value }),
                        children: y(Nr, {
                          value: M[C],
                          active: k && er(M[C]) === er(k[C]),
                          onClick: function () {
                            return x(M.value);
                          }
                        })
          ...
          children: y(Nr, { value: f, style: { margin: 4 } })
        }),
        y(wa, {
          id: ne(e),
          value: v,
        ...
        v ? y(ka, { icon: 'markup', onClick: O }) : null
      ]
    });
  };
export { La as ColorControl, La as default };
//# sourceMappingURL=Color-3c22bb81.8f26b142.js.map
